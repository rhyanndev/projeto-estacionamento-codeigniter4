...
abstract class BaseController extends Controller
{
    ...
    public function initController(RequestInterface $request, ResponseInterface $response, LoggerInterface $logger)
    {
        ...
        $this->dataToView['title'] = $company->name ?? 'Com MongoDB, MySQL e Postgre';
    ...
    // Método que vai ser responsável por identificar qual é o verbo HTTP que se está esperando
    //Para determinado método lá no controlador
